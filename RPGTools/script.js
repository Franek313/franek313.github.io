...
function playRandomSong(category, musicAudioPlayer)
{
    ...
    var audioUrl = `Audio/${category}/${musicMap.get(category)[randomIndex]}`;
...
$(document).ready(function() {
    ...
    // Tworzenie przycisków i dodawanie ich do centerPanel
    $.each(categories, function(index, name) {
        var button = $('<button>').text(name).attr('class', 'GenreButton'); // Tworzenie przycisku
